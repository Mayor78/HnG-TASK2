...
const Orders = () => {
        ...
        <div className="mt-4">
          ...
          {order.products && order.products.length > 0 ? (
            order.products.map((product) => {
              const title = product.name.length > 20 ? `${product.name.substr(0, 20)}...` : product.name;
              return (
                <div
                  key={product.id}
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="font-medium">Description: {product.shortDescription}</p>
                  </div>
                </div>
              );
            })
  ...
  return (
    <div className="container mx-0 md:mx-auto p-7 bg-white w-[100vw] md:[60vw]">
